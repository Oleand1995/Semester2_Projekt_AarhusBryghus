...
public class Opret_Prisliste_Window extends Stage {

    private Prisliste prisliste;

    public Opret_Prisliste_Window(String title, Prisliste prisliste) {
    ...
    public Opret_Prisliste_Window(String title) {
        this(title,null);
    }
