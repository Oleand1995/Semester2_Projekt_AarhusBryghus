...
class ControllerTest {
    ...
    void getSalgFromDato(){
        ...
        controller.createSalg(LocalDateTime.of(LocalDate.of(2022,4 ,8), LocalTime.of(12,0)),ordreLinjerUdenKlip,0,ordrelinjerSamletPris, Betalingsmåder.Dankort);
        controller.createSalg(LocalDateTime.of(LocalDate.of(2022,4 ,9), LocalTime.of(15,0)),ordreLinjerUdenKlip,0,ordrelinjerSamletPris, Betalingsmåder.Dankort);
        controller.createSalg(LocalDateTime.of(LocalDate.of(2022,4 ,10), LocalTime.of(20,0)),ordreLinjerUdenKlip,0,ordrelinjerSamletPris, Betalingsmåder.Dankort);
